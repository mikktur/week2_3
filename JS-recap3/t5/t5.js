...
// your code here
var map = L.map('map').setView([60.192, 24.945], 10);
...
restaurants.forEach(r => {
  ...
  marker.bindPopup(`<h3>${r.name}</h3><p>${r.address}, ${r.city}</p>`);
});

//miks nää koordinaatit on ihan väärinpäin tosa restaraunt jsonissa :(
